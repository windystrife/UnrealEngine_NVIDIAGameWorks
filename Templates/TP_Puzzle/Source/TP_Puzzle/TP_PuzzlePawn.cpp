...
void ATP_PuzzlePawn::Tick(float DeltaSeconds)
{
...
void ATP_PuzzlePawn::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
...
void ATP_PuzzlePawn::CalcCamera(float DeltaTime, struct FMinimalViewInfo& OutResult)
{
...
void ATP_PuzzlePawn::TraceForBlock(const FVector& Start, const FVector& End, bool bDrawDebugHelpers)
{
