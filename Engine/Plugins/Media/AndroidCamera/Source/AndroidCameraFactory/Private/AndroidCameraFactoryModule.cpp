...
DEFINE_LOG_CATEGORY(LogAndroidCameraFactory);

#define LOCTEXT_NAMESPACE "FAndroidCameraFactoryModule"


/**
 * Implements the AndroidCameraFactory module.
 */
class FAndroidCameraFactoryModule
...
public:
	...
	{
		auto AndroidCameraModule = FModuleManager::LoadModulePtr<IAndroidCameraModule>("AndroidCamera");
		return (AndroidCameraModule != nullptr) ? AndroidCameraModule->CreatePlayer(EventSink) : nullptr;
	}
...
IMPLEMENT_MODULE(FAndroidCameraFactoryModule, AndroidCameraFactory);
