...
static const UChar GRAVE = (UChar)0x0060;
...
UnicodeString& RelativeDateFormat::format(  Calendar& cal,
    ...
    if (fDatePattern.isEmpty()) {
        ...
        if (relativeDayString.length() > 0) {
            ...
            relativeDayString.findAndReplace(UNICODE_STRING("`", 1), UNICODE_STRING("``", 2)); // double any existing GRAVE
            relativeDayString.insert(0, GRAVE); // add GRAVE at beginning...
            relativeDayString.append(GRAVE); // and at end
