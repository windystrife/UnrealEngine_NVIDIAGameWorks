...
enum UCharPropertySource {
    ...
    /** One more than the highest UCharPropertySource (UPROPS_SRC_) constant. */
    UPROPS_SRC_COUNT
};
typedef enum UCharPropertySource UCharPropertySource;

/**
 * @see UCharPropertySource
 * @internal
 */
