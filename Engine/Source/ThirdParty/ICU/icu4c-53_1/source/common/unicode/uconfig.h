...
/**
 * \def UCONFIG_MSGPAT_DEFAULT_GRAVE_MODE
 * Determines the default UMessagePatternGraveMode.
 * See the documentation for that enum.
 *
 * @stable ICU 4.8
 */
#ifndef UCONFIG_MSGPAT_DEFAULT_GRAVE_MODE
#   define UCONFIG_MSGPAT_DEFAULT_GRAVE_MODE UMSGPAT_GRAVE_DOUBLE_OPTIONAL
#endif
