...
namespace Ionic.Zip
{
    ...
    partial class ZipEntry
    {
		...
		// EPIC GAMES START
		// Added code to allow a Zip to be produced on a PC with Unix-style attributes

		/// <summary>
		/// Changes the platform ID in the VersionMadeByField, as well as the external file attributes field
		/// </summary>
		/// <param name="PlatformID"></param>
		/// <param name="NewExternalFileAttributes"></param>
		public void AdjustExternalFileAttributes( byte PlatformID, Int32 NewExternalFileAttributes )
		{
			_VersionMadeBy = ( Int16 )( ( _VersionMadeBy & 0xFF ) | ( PlatformID << 8 ) );
			_metadataChanged = true;
			_ExternalFileAttrs = NewExternalFileAttributes;
		}

		/// <summary>
		/// Reads the version made by (zip version and OS that added the entry)
		/// </summary>
