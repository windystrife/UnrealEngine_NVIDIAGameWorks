...
namespace mtlpp
{
    RenderPipelineColorAttachmentDescriptor::RenderPipelineColorAttachmentDescriptor() :
        ns::Object(ns::Handle{ (__bridge void*)[[MTLRenderPipelineColorAttachmentDescriptor alloc] init] }, false)
    {
    }
    ...
    RenderPipelineReflection::RenderPipelineReflection() :
        ns::Object(ns::Handle{ (__bridge void*)[[MTLRenderPipelineReflection alloc] init] }, false)
    {
    }
    ...
    RenderPipelineDescriptor::RenderPipelineDescriptor() :
        ns::Object(ns::Handle{ (__bridge void*)[[MTLRenderPipelineDescriptor alloc] init] }, false)
    {
    }
	...
	ns::Array<PipelineBufferDescriptor> RenderPipelineDescriptor::GetVertexBuffers() const
	{
		...
		return ns::Handle{ [(__bridge MTLRenderPipelineDescriptor*)m_ptr vertexBuffers] };
#else
	...
	ns::Array<PipelineBufferDescriptor> RenderPipelineDescriptor::GetFragmentBuffers() const
	{
		Validate();
#if MTLPP_IS_AVAILABLE(10_13, 11_0)
		return ns::Handle{ [(__bridge MTLRenderPipelineDescriptor*)m_ptr fragmentBuffers] };
#else
		return ns::Array<PipelineBufferDescriptor>();
#endif
	}
	...
	{
#if MTLPP_IS_AVAILABLE(10_13, 11_0)
		[(__bridge MTLRenderPipelineDescriptor*)m_ptr setVertexBuffers:(MTLPipelineBufferDescriptorArray*)array.GetPtr()];
#endif
	}
	...
	{
#if MTLPP_IS_AVAILABLE(10_13, 11_0)
		[(__bridge MTLRenderPipelineDescriptor*)m_ptr setFragmentBuffers:(MTLPipelineBufferDescriptorArray*)array.GetPtr()];
#endif
	}
