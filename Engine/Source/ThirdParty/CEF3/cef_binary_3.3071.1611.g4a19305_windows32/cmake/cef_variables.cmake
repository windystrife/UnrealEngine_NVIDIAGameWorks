...
if(OS_MACOSX)
  ...
  list(APPEND CEF_CXX_COMPILER_FLAGS
    ...
    -fvisibility-inlines-hidden     # Give hidden visibility to inlined class member functions
    -std=c++11                      # Use the C++11 language standard without GNU extensions
    -stdlib=libc++                  # Select correct c++ std library compatible with clang
    -Wno-narrowing                  # Don't warn about type narrowing
    -Wsign-compare                  # Warn about mixed signed/unsigned type comparisons
    )
  list(APPEND CEF_COMPILER_FLAGS_DEBUG
...
if(OS_WINDOWS)
  ...
  if(USE_OFFICIAL_BUILD_SANDBOX)
    ...
    list(APPEND CEF_COMPILER_FLAGS_DEBUG
      /MD           # Multithread-specific and DLL-specific release version of the run-time library
      )
  else()
    list(APPEND CEF_COMPILER_FLAGS_DEBUG
      /MDd          # Multithread-specific and DLL-specific debug version of the run-time library
