...
static inline void layer_init_instance_dispatch_table(VkInstance instance, VkLayerInstanceDispatchTable *table, PFN_vkGetInstanceProcAddr gpa) {
    ...
    table->GetPhysicalDeviceProperties2KHX = (PFN_vkGetPhysicalDeviceProperties2KHX) gpa(instance, "vkGetPhysicalDeviceProperties2KHX");
    table->GetPhysicalDeviceImageFormatProperties2KHX = (PFN_vkGetPhysicalDeviceImageFormatProperties2KHX) gpa(instance, "vkGetPhysicalDeviceImageFormatProperties2KHX");
