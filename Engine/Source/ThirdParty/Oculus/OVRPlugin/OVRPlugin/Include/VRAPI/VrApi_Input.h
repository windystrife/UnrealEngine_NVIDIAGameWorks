...
///--BEGIN_SDK_REMOVE
	ovrButton_VolUp     = 0x00400000,	// + button on the Gear VR Controller and headset, but never sent to applications
	ovrButton_VolDown   = 0x00800000,	// - button on the Gear VR Controller and headset, but never sent to applications
