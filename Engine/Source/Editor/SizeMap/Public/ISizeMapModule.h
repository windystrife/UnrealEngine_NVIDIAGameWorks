 ...
 */
class ISizeMapModule : public IModuleInterface
{
...
public:
	 ...
	 */
	static inline ISizeMapModule& Get()
	{
		return FModuleManager::LoadModuleChecked< ISizeMapModule >( "SizeMap" );
	}
	...
	{
		return FModuleManager::Get().IsModuleLoaded( "SizeMap" );
	}
